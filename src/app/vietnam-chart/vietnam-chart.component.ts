...
import { IVietnamData, Data } from '../models/data.model';

@Component({
  selector: 'app-vietnam-chart',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './vietnam-chart.component.html',
  styleUrls: ['./vietnam-chart.component.scss']
})


export class VietnamChartComponent implements OnInit, OnChanges {
